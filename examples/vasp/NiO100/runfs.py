...
band_gap={'VBM':[0.8484,-0.1548],             # If band gap exists (You might need to confirm the occupation of VBM and CBM):
          'CBM':[2.9036, 2.7445]}             # non-spin polarization: set as 'VBM':[E_VBM],'CBM':[E_CBM] (Do not minus E_fermi)
